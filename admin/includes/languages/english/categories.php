...
// BEGIN EVENTS CALENDAR 1.1
	define('TEXT_PRODUCT_EVENT_BEGINS', '<font color="#008800">This event will begin on %s.</font>');
	define('TEXT_PRODUCT_EVENT_EXPIRES', '<font color="#0000ff">This event will expire on %s.</font>');
